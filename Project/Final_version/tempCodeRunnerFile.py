...
class Bimaru(Problem):
    ...
    def actions(self, state: BimaruState):
                ...
                if state.board.rows[col_j] >= 4:
                    for row_i in range(10):
                        ...
                        if row_i <= 6 and state.board.matrix[row_i, col_j] == "0" and state.board.matrix[row_i + 1, col_j] == "0" and state.board.matrix[row_i + 2, col_j] == "0" and state.board.matrix[row_i + 3, col_j] == "0":
                            actions_list.append(4,(row_i, col_j,"T"),(row_i + 1, col_j,"M"),(row_i + 2, col_j,"M"),(row_i + 3, col_j,"B"))
        ...
        if state.board.BoatSizes[2] != 0:
            for row_i in range(len(state.board.rows)):
                if state.board.rows[row_i] >= 2:
                    for col_j in range(10):
                        if state.board.matrix[row_i, col_j] == ".":
                            pass
                        if col_j <= 8 and state.board.matrix[row_i, col_j] == "0" and state.board.matrix[row_i, col_j + 1] == "0":
                            actions_list.append(2,(row_i, col_j,"L"),(row_i, col_j + 1,"R"))
            
            for col_j in range(len(state.board.collumns)):
                if state.board.rows[col_j] >= 2:
                    for row_i in range(10):
                        if state.board.matrix[row_i, col_j] == ".":
                            pass
                        if row_i <= 8 and state.board.matrix[row_i, col_j] == "0" and state.board.matrix[row_i + 1, col_j] == "0":
                            actions_list.append(2,(row_i, col_j,"T"),(row_i + 1, col_j,"B"))
        
        """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
        if state.board.BoatSizes[1] != 0:
            for row_i in range(len(state.board.rows)):
                 if state.board.rows[row_i] >= 1:
                     for col_j in range(10):
                         if state.board.matrix[row_i, col_j] == "0":
